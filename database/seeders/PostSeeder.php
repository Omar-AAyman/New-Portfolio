    ...
    public function run(): void
    {
        $posts = [
            ...
            [
                ...
                'content_ar' => '<h2>الأمن ما وراء الأساسيات</h2><p>بينما يوفر Laravel حماية مدمجة ضد CSRF و XSS، تتطلب التطبيقات عالية الأمان نهجاً أكثر صرامة، بما في ذلك سياسة أمن المحتوى (CSP)، وتحديد معدل الطلبات (Rate Limiting)، ومنع حقن SQL المتقدم.</p><h3>تحصين النظام الأساسي</h3><ul><li><strong>تحديد معدل الطلبات:</strong> حماية واجهات البرمجة من هجمات القوة الغاشمة (Brute Force) و DoS.</li><li><strong>تشفير البيانات الثابتة:</strong> ضمان تشفير معلومات الهوية الشخصية الحساسة داخل قاعدة البيانات.</li><li><strong>سجلات التدقيق:</strong> تتبع كل إجراء حساس داخل النظام للتحليل الجنائي.</li></ul>',
                'author' => 'Omar Ayman',
            ...
            [
                ...
                'content_ar' => '<h2>ما وراء استعلامات Eloquent</h2><p>يعد Eloquent قوياً، لكن التقارير المعقدة غالباً ما تتطلب SQL خاماً أو تقنيات Query Builder متقدمة مثل الاستعلامات الفرعية (Subqueries) والتجميعات الشرطية لتبقى فعالة.</p><h3>نصائح لهجرة قواعد البيانات دون توقف</h3><ul><li><strong>إدارة الفهارس (Indexes):</strong> ضمان دعم كل استعلام عالي الحركة بفهرس فعال.</li><li><strong>استخدام أعمدة JSON:</strong> الاستفادة من JSONB في PostgreSQL/MySQL لبيانات مرنة وعالية الأداء بدون مخطط ثابت.</li></ul>',
                'author' => 'Omar Ayman',
